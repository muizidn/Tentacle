...
class BranchTests: XCTestCase {
    ...
    func testDecodingBranches() {
        let expected = [
            Branch(name: "debuggin", sha: "117775803ff583c467dac3cd2c923b8d3f7d1869"),
            Branch(name: "master", sha: "567f8849cddadcd2469bafcad9d4f700ba4df881"),
            Branch(name: "playground", sha: "131709d54e1157699e44300cb9b9f8d22f2807e7")
        ]
